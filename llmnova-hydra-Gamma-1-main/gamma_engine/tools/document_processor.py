...
class DocumentProcessorTool(Tool):
    ...
    def __init__(self):
        super().__init__(
            ...
            description=(
                "Process various document formats (PDF, images) to extract text and convert to Markdown. "
                "Actions: 'extract_text_from_pdf', 'extract_text_from_image', 'convert_to_markdown'."
            ),
            parameters={
                "type": "object",
                "properties": {
                    "action": {
                        "type": "string",
                        "enum": ["extract_text_from_pdf", "extract_text_from_image", "convert_to_markdown"],
    ...
    def extract_text_from_image(self, file_path: str) -> str:
        ...
        """
        return self.ocr_tool.recognize(file_path)
    ...
    def convert_to_markdown(self, file_path: str, output_path: Optional[str] = None) -> str:
        ...
        if file_path.lower().endswith(".pdf"):
            ...
            try:
                ...
                return f"Error reading file for Markdown conversion: {e}"
    ...
    def execute(self, action: str, file_path: str, output_path: Optional[str] = None) -> Any:
        """
        ...
        if action == "extract_text_from_pdf":
            ...
            return f"Error: Unknown document processor action '{action}'"
